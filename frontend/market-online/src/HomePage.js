...
import SearchAsta from './components/searchAsta';
  ...
  return(
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/Ortoshop/:productId" element={<Products/>} />
        <Route path="/Ortoshop/aste/:codiceAsta" element={<SearchAsta/>} />
        <Route path="/Ortoshop/products/:citta" element={<SearchCitta/>} />
      </Routes>
    </BrowserRouter>
